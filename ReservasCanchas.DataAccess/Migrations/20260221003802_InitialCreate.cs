        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartIllumination = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    AditionalIllumination = table.Column<int>(type: "integer", nullable: false),
                    CBU = table.Column<string>(type: "text", nullable: false),
                    ComplexState = table.Column<int>(type: "integer", nullable: false),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
                    CancelationReason = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ComplexesId = table.Column<int>(type: "integer", nullable: false),
                    ServicesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComplexService", x => new { x.ComplexesId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_ComplexService_Complex_ComplexesId",
                        column: x => x.ComplexesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoucherPath = table.Column<string>(type: "text", nullable: true),
